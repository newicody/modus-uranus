...
**Vue principale : Atelier** (réaliste) — la voiture en 3D, taxonomie mécanique réelle.
...
- **Claude Pro** → **analyse des images** (vision) : reconnaissance pièce sur photo + commentaire → mapping vers `historique.md`.
...
5. **Recalage des coordonnées** via la caméra virtuelle.
